...
def create_matrix(secuences, kmers_size, step_size, max_step):
    #Numero de genomas
    n = len(secuences)
...
#Agrega una lista de genonas a una matriz ya hecha
def add_genomas_matrix(mat, secuences, kmers_size, step_size, max_step):
    mat1 = create_matrix(secuences, kmers_size, step_size, max_step)
