...
Config para el modo original, ejemplo (vect_escherichia_10.json):
{
    "genomes_dir": "/files2/generic-amr/data/genomes",
    "csv_file": "data/processed/escherichia_10.csv",
    "mat_B": "data/processed/vectors_topB_escherichia.csv",
    "mat_E": "data/processed/vectors_topE_escherichia.csv",
    "kmer_size": 4,
    "step_size": 4,
...
"names_out" (opcional, solo aplica al modo nuevo) escribe un CSV con
columna "name" = accession, en el mismo formato que espera
run_pipeline3.py para las etiquetas del arbol.
